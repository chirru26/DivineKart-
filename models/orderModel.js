...
orderId: { type: String, unique: true, required: true },
    user: { type: mongoose.Schema.Types.ObjectId, ref: 'User' },  //user logged-in
    customer: {
        name: { type: String, required: true },
...
orderSchemas.index({ createdAt: -1 });
orderSchemas.index({ user: 1 });

//SERVER PRICING LOGIC
orderSchemas.pre('save', function(next) {
...
const Order = mongoose.models.Order || mongoose.model('Order', orderSchemas);
